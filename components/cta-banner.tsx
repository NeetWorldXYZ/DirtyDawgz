      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-6 px-4 text-center lg:px-8">
        ...
        <div className="flex w-full max-w-md flex-col gap-4 sm:w-auto sm:max-w-none sm:flex-row">
          <Button
            asChild
            size="lg"
            className="h-12 w-full bg-secondary px-8 text-lg font-semibold text-secondary-foreground hover:bg-secondary/90 sm:w-auto"
          >
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="h-12 w-full border-primary-foreground/30 bg-transparent px-8 text-lg text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground sm:w-auto"
          >
