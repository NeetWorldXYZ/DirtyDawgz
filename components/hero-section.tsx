...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-secondary text-secondary-foreground">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center gap-10 px-4 py-14 text-center sm:py-20 lg:flex-row lg:gap-16 lg:px-8 lg:py-32 lg:text-left">
        <div className="flex flex-1 flex-col items-center lg:items-start">
          ...
          <div className="mt-8 flex w-full max-w-md flex-col gap-4 sm:w-auto sm:max-w-none sm:flex-row">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="h-12 w-full border-secondary-foreground/20 bg-transparent px-8 text-lg text-secondary-foreground hover:bg-secondary-foreground/5 hover:text-secondary-foreground sm:w-auto"
            >
        ...
        <div className="flex flex-1 items-center justify-center lg:justify-end">
          <div className="relative">
            ...
            <Image
              ...
              width={500}
              height={500}
              sizes="(max-width: 640px) 14rem, (max-width: 1024px) 20rem, 500px"
              className="relative h-auto w-56 rounded-full sm:w-80 lg:w-[500px]"
              priority
            />
          </div>
        </div>
